...
def add_metadata_columns_to_schema(schema_message):
    ...
    extended_schema_message["schema"]["properties"]["_sys_event_type"] = {
            "type": "integer"
    }

    extended_schema_message["schema"]["properties"]["_sys_log_position"] = {
            "type": "integer"
    }
    ...
    extended_schema_message["schema"]["properties"]["_is_deleted"] = {
        "type": ["null", "boolean"]
    }
...
def add_metadata_values_to_record(record_message, stream_to_sync):
    ...
    # Assume insert=1
    extended_record["_sys_event_type"] = record_message.get("record", {}).get(
            "_sys_event_type", 1
    )

    extended_record["_sys_transaction_lineno"] = record_message.get("record", {}).get(
            "_sys_transaction_lineno", -1
    )
